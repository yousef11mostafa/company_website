        ...
        <div class="col-12">
          ...
          <div class="card-deck">
            <div class="card shadow mb-4">
              ...
              <div class="card-body">
                <form method="POST" action="{{ route("superadmin.features.store") }}" enctype="multipart/form-data">
                    @csrf
                  ...
                  <div class="form-group">
                    ...
                    <textarea name="description" class="form-control" id="inputAddress2" >{{ $feature->description }}</textarea>
